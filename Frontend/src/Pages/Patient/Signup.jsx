...
const Signup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    console.log("🚀 Sending signup request with data:", { ...formData, role: selectedRole });
    ...
    try {
      ...
      if (response?.msg && response.msg.includes("OTP sent to email")) {
    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-100 px-4">
      <div className="w-full max-w-md p-6 bg-white rounded-lg shadow-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button type="submit" className="w-full bg-blue-500 hover:bg-blue-600 text-white py-2 rounded-md transition disabled:bg-gray-400" disabled={loading}>

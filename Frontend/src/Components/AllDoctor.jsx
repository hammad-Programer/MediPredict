  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 overflow-x-hidden">
      <div className="flex flex-col lg:flex-row gap-6">
        {/* Sidebar */}
        {/* Dropdown on Mobile */}<div className="block lg:hidden w-full mb-4">
 <div className="block lg:hidden w-full mb-4">
  ...
  >
    {specialties.map((spec) => (
      <option key={spec} value={spec} className="text-blue-700">
        {spec}
      </option>
    ))}
  </select>
...
{/* Sidebar on Desktop */}
<aside className="hidden lg:block w-48 shrink-0 mb-0">

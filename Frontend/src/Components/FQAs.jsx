    ...
    <div className="max-w-3xl mx-auto my-12 px-4 sm:px-6 md:px-8">
      ...
      <section className="bg-gray-100 mt-16 py-12 text-center rounded-lg">
        ...
        <button 
          ...
          className="mt-6 bg-blue-500 hover:bg-blue-600 text-white px-5 py-2 rounded-md font-medium text-sm flex items-center mx-auto transition"
        >
      ...
      <section className="mt-16 py-12 text-center bg-white-500 shadow-lg rounded-lg">
        ...
        <div className="mt-6 flex justify-center space-x-4">
          ...
          <button 
            ...
            className="bg-blue-500 hover:bg-blue-600 text-white px-5 py-2 rounded-md font-medium text-xs sm:text-sm flex items-center transition"
          >
